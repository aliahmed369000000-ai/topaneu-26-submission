...
# FLIP_MAP يُستورد من vessel_preprocessing.py (مصدر وحيد، يمنع تكرار/تعارض
# محتمل بين الملفات المختلفة -- راجع جلسة التصميم لتفاصيل خطأ سابق مشابه
# اكتُشف في train_tpu.py بسبب عدم وجود مصدر موحّد).
